# Generated by Django 5.0.14 on 2026-07-29 17:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('impact', models.TextField(blank=True, max_length=500, verbose_name='Impact')),
                ('min_requirements', models.TextField(blank=True, max_length=500, verbose_name='Minimum requirements')),
                ...
                ('is_published', models.BooleanField(default=False, help_text='Show this problem statement on the public tracks page.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weightage', models.PositiveIntegerField(default=0, help_text='Percentage this round contributes to the total score.')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_problem_live', models.BooleanField(default=False, help_text='Make this track problem statement visible to participants.')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problem_statement', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='booked_teams', to='core.problemstatement')),
        ...
        migrations.AddField(
            ...
            name='track',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='problem_statement_slots', to='core.track'),
        ),
        migrations.CreateModel(
            name='Prize',
            fields=[
